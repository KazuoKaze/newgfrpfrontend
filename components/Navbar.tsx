    ...
    <nav className="navbar navbar_var-seven">
      <div className="navbar_container navbar_var-seven">
        ...
        <div
          ...
          {...(isMobileOrTablet ? { id: "ss" } : {})}
        >
          <a href="/about" className="navbar_links-item cc-button-text">
            About
          </a>
          <a href="/resource" className="navbar_links-item cc-button-text">
            Resources
          </a>
          <a href="/product" className="navbar_links-item cc-button-text">
            Machine
          </a>
          <a href="/blog" className="navbar_links-item cc-button-text">
            Blog
          </a>
          <div className="nav-cta_wrapper">
            <a
          ...
          {!isOpen ? (
            ...
            >
              ...
              <g clipPath="url(#__lottie_element_2)">
                <g transform="matrix(1,0,0,1,356,356)" opacity="1">
                  <g opacity="1" transform="matrix(1,0,0,1,0,0)">
                    <path
                      strokeLinecap="round"
            ...
            >
              ...
              <g clipPath="url(#__lottie_element_2)">
                <g transform="matrix(1,0,0,1,356,335)" opacity="1">
                  <g opacity="1" transform="matrix(1,0,0,1,0,0)">
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="miter"
                ...
                <g transform="matrix(1,0,0,1,356,377)" opacity="1">
                  <g opacity="1" transform="matrix(1,0,0,1,0,0)">
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="miter"
